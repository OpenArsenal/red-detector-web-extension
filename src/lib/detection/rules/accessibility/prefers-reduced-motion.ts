	...
	rules: [
		{
			...
			kind: "html",
			pattern: new RegExp("prefers-reduced-motion", "i"),
			confidence: 95,
			description: "Inline CSS references prefers-reduced-motion.",
		},
		{
			...
			pattern: new RegExp("prefers-reduced-motion", "i"),
			confidence: 100,
			description: "Stylesheet CSS references prefers-reduced-motion.",
		},
	],
