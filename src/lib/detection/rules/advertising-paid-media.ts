...
export const advertisingPaidMediaTechnologyDefinitions = [
	...
	},
	{
		...
		rules: [
			...
			{
				id: "a8-net:pageGlobal:2",
				kind: "pageGlobal",
				property: "A8salesCookieRepository",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "a8-net:pageGlobal:3",
				kind: "pageGlobal",
				property: "a8sales",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "a8-net:pageGlobal:4",
				kind: "pageGlobal",
				property: "map_A8",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			{
				id: "acuityads:pageGlobal:0",
				kind: "pageGlobal",
				property: "acuityAdsEventQueue",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "acuityads:pageGlobal:1",
				kind: "pageGlobal",
				property: "acuityAdsPixelKey",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "acuityads:responseHeader:2",
				kind: "responseHeader",
				key: "Content-Security-Policy",
				valuePattern: new RegExp("\\.acuityplatform\\.com"),
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adcash:pageGlobal:2",
				kind: "pageGlobal",
				property: "SuLoaded",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adcash:pageGlobal:3",
				kind: "pageGlobal",
				property: "SuUrl",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adcash:pageGlobal:4",
				kind: "pageGlobal",
				property: "ac_bgclick_URL",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adcash:pageGlobal:5",
				kind: "pageGlobal",
				property: "ct_nOpp",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adcash:pageGlobal:6",
				kind: "pageGlobal",
				property: "ct_nSuUrl",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adcash:pageGlobal:7",
				kind: "pageGlobal",
				property: "ct_siteunder",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adcash:pageGlobal:8",
				kind: "pageGlobal",
				property: "ct_tag",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adex:pageGlobal:2",
				kind: "pageGlobal",
				property: "_adexc",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adex:pageGlobal:3",
				kind: "pageGlobal",
				property: "adex.v",
	...
	},
	{
		...
		rules: [
			{
				id: "adfox:pageGlobal:0",
				kind: "pageGlobal",
				property: "AdFox_getCodeScript",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adfox:pageGlobal:1",
				kind: "pageGlobal",
				property: "Site.adFoxParams",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adfox:pageGlobal:2",
				kind: "pageGlobal",
				property: "adFoxParams",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adfox:pageGlobal:3",
				kind: "pageGlobal",
				property: "adfoxAsyncParams",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adfox:pageGlobal:4",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adition:pageGlobal:1",
				kind: "pageGlobal",
				property: "adition",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adition:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "admitad:pageGlobal:2",
				kind: "pageGlobal",
				property: "ADMITAD",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "admitad:pageGlobal:3",
				kind: "pageGlobal",
				property: "admitad",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "admixer:pageGlobal:1",
				kind: "pageGlobal",
				property: "admixerAds",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "admixer:pageGlobal:2",
				kind: "pageGlobal",
				property: "admixerML",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "admo-tv:pageGlobal:1",
				kind: "pageGlobal",
				property: "ADMO_TT",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "admo-tv:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adnegah:responseHeader:2",
				kind: "responseHeader",
				key: "X-Advertising-By",
				valuePattern: new RegExp("adnegah\\.net"),
				description: "Response header matches a known technology marker."
			}
		],
		metadata: {
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adocean:pageGlobal:2",
				kind: "pageGlobal",
				property: "ado.master",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adocean:pageGlobal:3",
				kind: "pageGlobal",
				property: "ado.placement",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adocean:pageGlobal:4",
				kind: "pageGlobal",
				property: "ado.slave",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adriver:pageGlobal:2",
				kind: "pageGlobal",
				property: "AdriverCounter",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adriver:pageGlobal:3",
				kind: "pageGlobal",
				property: "AdriverPrebid",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adriver:pageGlobal:4",
				kind: "pageGlobal",
				property: "adfoxBiddersMap.adriver",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adriver:pageGlobal:5",
				kind: "pageGlobal",
				property: "adriver",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adroll:pageGlobal:3",
				kind: "pageGlobal",
				property: "adroll_adv_id",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adroll:pageGlobal:4",
				kind: "pageGlobal",
				property: "adroll_pix_id",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adroll:pageGlobal:5",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adscale:pageGlobal:1",
				kind: "pageGlobal",
				property: "_adscale",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adscale:pageGlobal:2",
				kind: "pageGlobal",
				property: "adscaleAddToCart",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adscale:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "adthrive:pageGlobal:1",
				kind: "pageGlobal",
				property: "adthrive",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "adthrive:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "anura:pageGlobal:1",
				kind: "pageGlobal",
				property: "Anura",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "anura:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "appnexus:pageGlobal:3",
				kind: "pageGlobal",
				property: "appnexus",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "appnexus:pageGlobal:4",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			{
				id: "arcspan:pageGlobal:0",
				kind: "pageGlobal",
				property: "aspan",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "arcspan:pageGlobal:1",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			{
				id: "assertive-yield:pageGlobal:0",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "awin:pageGlobal:3",
				kind: "pageGlobal",
				property: "AWIN.Tracking",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "awin:pageGlobal:4",
				kind: "pageGlobal",
				property: "zanox",
				description: "Page-owned global matches a known technology marker."
			},
	...
	},
	{
		...
		rules: [
			...
			{
				id: "blue:pageGlobal:2",
				kind: "pageGlobal",
				property: "blueProductId",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "blue:pageGlobal:3",
				kind: "pageGlobal",
				property: "bluecpy_id",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "buysellads:pageGlobal:2",
				kind: "pageGlobal",
				property: "_bsa",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "buysellads:pageGlobal:3",
				kind: "pageGlobal",
				property: "_bsaPRO",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "buysellads:pageGlobal:4",
				kind: "pageGlobal",
				property: "_bsap",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "buysellads:pageGlobal:5",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "carbon-ads:pageGlobal:2",
				kind: "pageGlobal",
				property: "_carbonads",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "carbon-ads:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "chitika:pageGlobal:1",
				kind: "pageGlobal",
				property: "ch_client",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "chitika:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "collective-audience:pageGlobal:1",
				kind: "pageGlobal",
				property: "BeOpSDK",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "collective-audience:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "concert:pageGlobal:1",
				kind: "pageGlobal",
				property: "CONCERT_ADS_CONFIG",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "concert:pageGlobal:2",
				kind: "pageGlobal",
				property: "ConcertAds",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "criteo:pageGlobal:3",
				kind: "pageGlobal",
				property: "Criteo",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "criteo:pageGlobal:4",
				kind: "pageGlobal",
				property: "criteo_pubtag",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "criteo:pageGlobal:5",
				kind: "pageGlobal",
				property: "criteo_q",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "digistore24:pageGlobal:3",
				kind: "pageGlobal",
				property: "DIGISTORE_LINK_ID_KEY",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "digistore24:pageGlobal:4",
				kind: "pageGlobal",
				property: "DIGISTORE_VENDORKEY",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "digistore24:pageGlobal:5",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "dolead:pageGlobal:1",
				kind: "pageGlobal",
				property: "dolead_affiliate_id",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "dolead:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "doubleclick-floodlight:scriptContent:1",
				kind: "scriptContent",
	...
	},
	{
		...
		rules: [
			{
				id: "ebay-store:pageGlobal:0",
				kind: "pageGlobal",
				property: "$ebay.tracking",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "ebay-store:pageGlobal:1",
				kind: "pageGlobal",
				property: "ebay.gadgetMonitoring",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "ebay-store:responseHeader:2",
				kind: "responseHeader",
				key: "Server",
				valuePattern: new RegExp("^ebay server$"),
				description: "Response header matches a known technology marker."
			}
		],
		metadata: {
	...
	},
	{
		...
		rules: [
			...
			},
			{
				id: "exoclick:meta:1",
				kind: "meta",
				key: "exoclick-site-verification",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "firstimpression-io:pageGlobal:2",
				kind: "pageGlobal",
				property: "FI.options",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "firstimpression-io:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "firstpromoter:pageGlobal:2",
				kind: "pageGlobal",
				property: "FirstPromoterAPI",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "firstpromoter:pageGlobal:3",
				kind: "pageGlobal",
				property: "fprom_obj_",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "freakout:pageGlobal:2",
				kind: "pageGlobal",
				property: "FOut",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "freakout:pageGlobal:3",
				kind: "pageGlobal",
				property: "_fout_jsurl",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "freakout:pageGlobal:4",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "google-adsense:scriptSrc:3",
				kind: "scriptSrc",
				pattern: new RegExp("ad\\.ca\\.doubleclick\\.net"),
				description: "Script source URL matches a known technology marker."
			},
			{
				id: "google-adsense:dom:4",
				kind: "dom",
				selector: "amp-ad[type='adsense']",
				description: "DOM selector matches a known technology marker."
			},
			{
				id: "google-adsense:pageGlobal:5",
				kind: "pageGlobal",
				property: "Goog_AdSense_",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "google-adsense:pageGlobal:6",
				kind: "pageGlobal",
				property: "Goog_AdSense_OsdAdapter",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "google-adsense:pageGlobal:7",
				kind: "pageGlobal",
				property: "__google_ad_urls",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "google-adsense:pageGlobal:8",
				kind: "pageGlobal",
				property: "adsbygoogle",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "google-adsense:pageGlobal:9",
				kind: "pageGlobal",
				property: "google_ad_",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "impact:pageGlobal:1",
				kind: "pageGlobal",
				property: "ImpactRadiusEvent",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "impact:pageGlobal:2",
				kind: "pageGlobal",
				property: "irEvent",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			{
				id: "infolinks:pageGlobal:0",
				kind: "pageGlobal",
				property: "infolinks_pid",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "infolinks:pageGlobal:1",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "innovid-advertising-measurement:pageGlobal:1",
				kind: "pageGlobal",
				property: "TV2Track",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "innovid-advertising-measurement:pageGlobal:2",
				kind: "pageGlobal",
				property: "_tvq",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			},
			{
				id: "juicyads:meta:1",
				kind: "meta",
				key: "juicyads-site-verification",
				description: "Meta tag matches a known technology marker."
			}
		],
		metadata: {
	...
	},
	{
		...
		rules: [
			...
			{
				id: "kevel:pageGlobal:2",
				kind: "pageGlobal",
				property: "ados",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "kevel:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "linkedin-ads:responseHeader:2",
				kind: "responseHeader",
				key: "Content-Security-Policy",
				valuePattern: new RegExp("px\\.ads\\.linkedin\\.com"),
				description: "Response header matches a known technology marker."
			}
		],
		metadata: {
	...
	},
	{
		...
		rules: [
			...
			{
				id: "linx-impulse:pageGlobal:1",
				kind: "pageGlobal",
				property: "linx.banner",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "linx-impulse:pageGlobal:2",
				kind: "pageGlobal",
				property: "linxImpulse.config",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "linx-impulse:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "lkqd:pageGlobal:3",
				kind: "pageGlobal",
				property: "lkqdCall",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "lkqd:pageGlobal:4",
				kind: "pageGlobal",
				property: "lkqdErrorCount",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "lkqd:pageGlobal:5",
				kind: "pageGlobal",
				property: "lkqdSettings",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "lkqd:pageGlobal:6",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "madadsmedia:pageGlobal:1",
				kind: "pageGlobal",
				property: "setMIframe",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "madadsmedia:pageGlobal:2",
				kind: "pageGlobal",
				property: "setMRefURL",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "mantis:pageGlobal:1",
				kind: "pageGlobal",
				property: "mantis",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "mantis:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "microsoft-advertising:pageGlobal:2",
				kind: "pageGlobal",
				property: "UET",
				description: "Page-owned global matches a known technology marker."
			},
	...
	},
	{
		...
		rules: [
			...
			{
				id: "pepperjam:pageGlobal:1",
				kind: "pageGlobal",
				property: "Pepperjam",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "pepperjam:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "post-affiliate-pro:pageGlobal:2",
				kind: "pageGlobal",
				property: "PostAffAction",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "post-affiliate-pro:pageGlobal:3",
				kind: "pageGlobal",
				property: "PostAffCookie",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "post-affiliate-pro:pageGlobal:4",
				kind: "pageGlobal",
				property: "PostAffInfo",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "post-affiliate-pro:pageGlobal:5",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "prebid:pageGlobal:2",
				kind: "pageGlobal",
				property: "PREBID_TIMEOUT",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "prebid:pageGlobal:3",
				kind: "pageGlobal",
				property: "pbjs",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "prebid:pageGlobal:4",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "primis:pageGlobal:3",
				kind: "pageGlobal",
				property: "SekindoNativeSkinApi",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "primis:pageGlobal:4",
				kind: "pageGlobal",
				property: "sekindoDisplayedPlacement",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "primis:pageGlobal:5",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "rakuten:pageGlobal:2",
				kind: "pageGlobal",
				property: "rakutenRanMID",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "rakuten:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "raptive:pageGlobal:1",
				kind: "pageGlobal",
				property: "adthrive",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "raptive:pageGlobal:2",
				kind: "pageGlobal",
				property: "adthriveVideosInjected",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			{
				id: "sabavision:pageGlobal:0",
				kind: "pageGlobal",
				property: "SabavisionElement",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "sabavision:pageGlobal:1",
				kind: "pageGlobal",
				property: "__SABAVISION_GET_ADD_TIMEOUT",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "sabavision:pageGlobal:2",
				kind: "pageGlobal",
				property: "sabaVisionWebsiteID",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "sabavision:pageGlobal:3",
				kind: "pageGlobal",
				property: "sabaVisionWebsitePage",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "sabavision:meta:4",
				kind: "meta",
				key: "sabavision_zone",
				description: "Meta tag matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "sharpspring-ads:pageGlobal:1",
				kind: "pageGlobal",
				property: "_pa",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			{
				id: "she-media:pageGlobal:0",
				kind: "pageGlobal",
				property: "SheMedia",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "she-media:pageGlobal:1",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "skimlinks:pageGlobal:2",
				kind: "pageGlobal",
				property: "__SKIM_JS_GLOBAL__",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "skimlinks:pageGlobal:3",
				kind: "pageGlobal",
				property: "addSkimlinks",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "skimlinks:pageGlobal:4",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "smart-ad-server:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "smarter-click:pageGlobal:1",
				kind: "pageGlobal",
				property: "$smcInstall",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "smarter-click:pageGlobal:2",
				kind: "pageGlobal",
				property: "$smcT5",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "smarter-click:pageGlobal:3",
				kind: "pageGlobal",
				property: "$smctData",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "snap-pixel:scriptContent:1",
				kind: "scriptContent",
				pattern: new RegExp("_snapchat_pixel_id"),
				description: "Script content contains a bounded technology signature."
			},
			{
				id: "snap-pixel:pageGlobal:2",
				kind: "pageGlobal",
				property: "__SnapPixel",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "snap-pixel:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			{
				id: "social-snowball:pageGlobal:0",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "sovrn:pageGlobal:2",
				kind: "pageGlobal",
				property: "sovrn",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "sovrn:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "sovrn-commerce:pageGlobal:1",
				kind: "pageGlobal",
				property: "vglnk",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "sovrn-commerce:pageGlobal:2",
				kind: "pageGlobal",
				property: "vl_cB",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "sovrn-commerce:pageGlobal:3",
				kind: "pageGlobal",
				property: "vl_disable",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "taboola:pageGlobal:3",
				kind: "pageGlobal",
				property: "TRCImpl.global",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "taboola:pageGlobal:4",
				kind: "pageGlobal",
				property: "_taboola",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "taboola:pageGlobal:5",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			{
				id: "tagtoo:pageGlobal:0",
				kind: "pageGlobal",
				property: "tagtoo_advertiser_id",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "tagtoo:pageGlobal:1",
				kind: "pageGlobal",
				property: "tagtoo_ga",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "tagtoo:pageGlobal:2",
				kind: "pageGlobal",
				property: "tagtoo_s",
				description: "Page-owned global matches a known technology marker."
			}
		...
		rules: [
			{
				...
				kind: "meta",
				key: "generator",
				valuePattern: new RegExp("^Tempest\\s-\\smaven\\.io$"),
				description: "Meta tag matches a known technology marker."
			}
		],
		metadata: {
	...
	},
	{
		...
		rules: [
			...
			{
				id: "thetradedesk:pageGlobal:3",
				kind: "pageGlobal",
				property: "TTDUniversalPixelApi",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "thetradedesk:pageGlobal:4",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			{
				id: "titan:pageGlobal:0",
				kind: "pageGlobal",
				property: "titan",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "titan:pageGlobal:1",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "tolt:pageGlobal:2",
				kind: "pageGlobal",
				property: "tolt_referral",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "tolt:pageGlobal:3",
				kind: "pageGlobal",
				property: "toltio",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "tvsquared:pageGlobal:1",
				kind: "pageGlobal",
				property: "TV2Track",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "tvsquared:pageGlobal:2",
				kind: "pageGlobal",
				property: "_tvq",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			...
			{
				id: "uzerly:responseHeader:1",
				kind: "responseHeader",
				key: "content-security-policy",
				valuePattern: new RegExp("\\.u(?:s|z)erly\\.net"),
				description: "Response header matches a known technology marker."
			}
		],
		metadata: {
	...
	},
	{
		...
		rules: [
			...
			{
				id: "veoxa:scriptSrc:1",
				kind: "scriptSrc",
				pattern: new RegExp("tracking\\.veoxa\\.com"),
				description: "Script source URL matches a known technology marker."
			},
			{
				id: "veoxa:pageGlobal:2",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "vidazoo:pageGlobal:1",
				kind: "pageGlobal",
				property: "__vidazooPlayer__",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "vidazoo:pageGlobal:2",
				kind: "pageGlobal",
				property: "vidazoo",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "vidazoo:pageGlobal:3",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			{
				id: "yahoo-advertising:pageGlobal:2",
				kind: "pageGlobal",
				property: "adxinserthtml",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "yahoo-advertising:pageGlobal:3",
				kind: "pageGlobal",
				property: "yahooCvLoad",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "yahoo-advertising:pageGlobal:4",
				kind: "pageGlobal",
				property: "yahoo_retargeting_pv_id",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "yahoo-advertising:pageGlobal:5",
				kind: "pageGlobal",
				property: "yahoo_ydn_conv_label",
				description: "Page-owned global matches a known technology marker."
			},
			{
				id: "yahoo-advertising:pageGlobal:6",
				kind: "pageGlobal",
	...
	},
	{
		...
		rules: [
			...
			},
			{
				id: "yektanet:meta:1",
				kind: "meta",
				key: "yektanet_session_last_activity",
				description: "Meta tag matches a known technology marker."
			}
		],
		metadata: {
	...
	},
	{
		...
		rules: [
			...
			{
				id: "zanox:scriptSrc:1",
				kind: "scriptSrc",
				pattern: new RegExp("zanox\\.com/scripts/zanox\\.js$"),
				description: "Script source URL matches a known technology marker."
			},
			{
				id: "zanox:pageGlobal:2",
				kind: "pageGlobal",
				property: "zanox",
				description: "Page-owned global matches a known technology marker."
			}
	...
	},
	{
		...
		rules: [
			{
				id: "zeus-technology:pageGlobal:0",
				kind: "pageGlobal",
			...
			{
				id: "zeus-technology:pageGlobal:1",
				kind: "pageGlobal",
