...
The full phase 1 behavior baseline lives in [`docs/migration/phase-1-behavior-baseline.md`](docs/migration/phase-1-behavior-baseline.md). The phase 2 contract seams are described in [`docs/migration/phase-2-contract-seams.md`](docs/migration/phase-2-contract-seams.md), the phase 3 collector boundary is described in [`docs/migration/phase-3-collector-boundary.md`](docs/migration/phase-3-collector-boundary.md), the phase 4 lifecycle model is described in [`docs/migration/phase-4-extension-lifecycle.md`](docs/migration/phase-4-extension-lifecycle.md), the phase 5 graph seam is described in [`docs/migration/phase-5-graph-registry.md`](docs/migration/phase-5-graph-registry.md), the phase 6 popup view-model boundary is described in [`docs/migration/phase-6-popup-view-model.md`](docs/migration/phase-6-popup-view-model.md), the phase 7 test boundary is described in [`docs/migration/phase-7-test-boundaries.md`](docs/migration/phase-7-test-boundaries.md), the phase 9 observation seam is described in [`docs/migration/phase-9-observation-normalization.md`](docs/migration/phase-9-observation-normalization.md), the phase 10 evidence seam is described in [`docs/migration/phase-10-evidence-repository.md`](docs/migration/phase-10-evidence-repository.md), the phase 11 observation matcher seam is described in [`docs/migration/phase-11-observation-pattern-matching.md`](docs/migration/phase-11-observation-pattern-matching.md), the phase 12 evidence candidate seam is described in [`docs/migration/phase-12-evidence-candidates.md`](docs/migration/phase-12-evidence-candidates.md), the phase 13 candidate relationship seam is described in [`docs/migration/phase-13-candidate-relationship-refinement.md`](docs/migration/phase-13-candidate-relationship-refinement.md), the phase 14 emission parity seam is described in [`docs/migration/phase-14-emission-parity.md`](docs/migration/phase-14-emission-parity.md), and the current migration status is summarized in [`docs/migration/status.md`](docs/migration/status.md). Architecture docs live under [`docs/architecture/README.md`](docs/architecture/README.md), including the [phase 8 overview](docs/architecture/overview.md), [verification workflow](docs/architecture/verification-workflow.md), and [popup composition guide](docs/architecture/popup-composition.md). Before accepting messaging, collector, lifecycle, graph, or popup changes, run the extension in Chrome and verify:
...
- `src/lib/candidates/` — sidecar candidate aggregation and relationship refinement from evidence entries before final detection emission.
- `src/lib/detection/observation-matcher.ts` — sidecar matcher that turns normalized observations into evidence entries without replacing `analyzeSite(...)`.
